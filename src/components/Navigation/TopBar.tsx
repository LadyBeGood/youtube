    ...
    return (
        <nav className={`bg-black overflow-auto ${className}`}>
            ...
            <div className="h-12 flex px-3 items-center">
                ...
                <div className="hidden h-10 w-125 relative items-center border-1 border-white/20 rounded-full pl-2 pr-1 gap-2">
                    <SearchIcon size={22} />
                ...
                <div className="flex items-center content-between gap-5">
                    ...
                    <Link aria-label="Go to search" to="/search" className="">
                        <SearchIcon />
                    </Link>
                    ...
                    <Link
                        ...
                        className={isProfilePage ? "" : "hidden"}
                    >
