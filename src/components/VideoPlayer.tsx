    ...
    return (
        <>
            <div
                ...
                className="relative bg-green-500 w-full grid place-items-center"
                onClick={handleClick}
            >
                <video
                    ref={videoRef}
                ...
                >
                    ...
                    <div className="px-4 py-3 text-white flex justify-between">
                        ...
                        <div className="">
                            {/* Back Button */}
                            <button data-action="minimise" className="">
            ...
            <BottomSheet isBottomSheetOpen={isQualityBottomSheetOpen} middle={100} onBottomSheetClose={() => setIsQualityBottomSheetOpen(false)}>
                <div className="flex flex-col items-start">
                    {availableQualities.map((quality, index) =>
                        <button className="h-11 w-full hover:bg-white/10 flex items-center gap-3" key={index}>
                            <span>
