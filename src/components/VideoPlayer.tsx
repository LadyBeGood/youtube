...
const VideoPlayer = ({ source, title, thumbnail }: VideoPlayerProps) => {
    ...
    return (
        <div className="relative bg-green-500 w-full max-w-3xl mx-auto aspect-video" onClick={() => setShowControls(!showControls)}>
            <video
                ref={videoRef}
                src={source}
            ...
            <div className={`absolute inset-0 bg-black/60 flex flex-col justify-between transition-opacity duration-300 ${showControls ? "opacity-100" : "opacity-0 pointer-events-none"}`}>
                ...
                <div className="px-4 py-3 text-white flex justify-between">
                    ...
                    <div className="">
                        <button className="cursor-pointer">
                            <svg xmlns="http://www.w3.org/2000/svg" height="26px" width="26px" viewBox="0 -960 960 960" fill="#fff"><path d="M480-357.85 253.85-584 296-626.15l184 184 184-184L706.15-584 480-357.85Z" /></svg>
                        </button>
                    </div>
                ...
                <div className="absolute left-0 right-0 top-1/2 -translate-y-1/2  flex items-center justify-center gap-16">
                    <button className="cursor-pointer bg-black/30 p-2 rounded-full" onClick={(e) => { e.stopPropagation(); videoRef.current!.currentTime -= 10; }}>
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#fff"><path d="M220-240v-480h80v480h-80Zm520 0L380-480l360-240v480Z" /></svg>
                    </button>

                    <button onClick={(e) => { e.stopPropagation(); togglePlay(); }} className="cursor-pointer bg-black/30 p-2 rounded-full">
                        {isPlaying
                            ? <svg xmlns="http://www.w3.org/2000/svg" height="40px" width="40px" viewBox="0 -960 960 960" fill="#fff"><path d="M560-200v-560h160v560H560Zm-320 0v-560h160v560H240Z" /></svg>
                            : <svg xmlns="http://www.w3.org/2000/svg" height="40px" width="40px" viewBox="0 -960 960 960" fill="#fff"><path d="M320-200v-560l440 280-440 280Z" /></svg>
                        }
                    </button>

                    <button className="cursor-pointer bg-black/30 p-2 rounded-full" onClick={(e) => { e.stopPropagation(); videoRef.current!.currentTime += 10; }}>
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#fff"><path d="M660-240v-480h80v480h-80Zm-440 0v-480l360 240-360 240Z" /></svg>
                    </button>
                </div>
                ...
                <div className="px-4 pb-2 relative w-full">
                    <div className="flex justify-between items-baseline text-white text-xs mt-2 mb-2">
                        ...
                        <div className="flex gap-8">
                            ...
                            <button className="cursor-pointer">
                                <svg width="12" height="12" viewBox="0 0 18 18" fill="#fff" xmlns="http://www.w3.org/2000/svg"><path d="M0 18V11H2V16H7V18H0ZM11 18V16H16V11H18V18H11ZM0 7V0H7V2H2V7H0ZM16 7V2H11V0H18V7H16Z" fill="white" /></svg>
                            </button>
                        </div>
                    </div>
