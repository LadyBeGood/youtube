...
const history = [
    ...
    { name: "bit manipulation", preview: "./thumbnail1.webp" },
    { name: "bihar news live", preview: "./thumbnail1.webp" },
    { name: "unbox therapy", preview: "./thumbnail1.webp" },
    { name: "rechargeable led bulb", preview: "./thumbnail1.webp" },
    { name: "kapil sharma", preview: "./thumbnail1.webp" },
    { name: "teded", preview: "./thumbnail1.webp" },
    { name: "hyperplexed", preview: "./thumbnail1.webp" },
    { name: "t3gg", preview: "./thumbnail1.webp" },
    { name: "valid parenthesis string", preview: "./thumbnail1.webp" },
    { name: "candy leetcode", preview: "./thumbnail1.webp" },
    { name: "lemonade change", preview: "./thumbnail1.webp" },
    { name: "meeting rooms iii", preview: "./thumbnail1.webp" },
    { name: "meeting rooms", preview: "./thumbnail1.webp" },
