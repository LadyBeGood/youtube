            ...
            <div className="min-w-full">
                ...
                <div className="px-3 h-12 py-2 flex justify-between gap-2 no-scrollbar">
                    ...
                    <div className="flex gap-2">
                        <button className="font-medium hover:bg-white/20 text-white grid place-items-center px-3 rounded-full text-[12px]">
                            Join
                        </button>
                        <button className="font-medium text-eerie-black bg-white grid place-items-center px-3 rounded-full text-[12px]">
                            Subscribe
                        </button>
                    </div>
                </div>

                <div className="px-3 h-12 py-2 flex overflow-x-auto gap-3 no-scrollbar select-none">
                    ...
                    {/* Share Button */}
                    <button className="px-3 bg-dark-gray rounded-full flex items-center text-[12px] gap-1">
                ...
                <div className="bg-dark-gray mt-2 mb-4 mx-3 py-2.5 px-3 rounded-xl cursor-pointer select-none">
                    ...
                    <div className="flex gap-2 items-center">
                        ...
                        <div className="text-[12px]">Thank you so much for not adding some stupid music / song to it.</div>
                    </div>
                </div>
