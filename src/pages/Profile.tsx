            ...
            <div className="h-full">
                <Tabs activeIndex={index} onTabChange={onTabChange} className="h-full w-full select-none" inkColor="white" activeTabColor="white">
                    ...
                    <PanelList className="h-full">
                        <Panel>
                            <Video title={"Build Amazon Clone usisng React JS for Beginners | Complete Website like Amazon In React JS 2025"} channel={"CodingHunger"} profilePictureURL={"./avatar1.webp"} views={"12K"} uploadDate={"1 year ago"} thumbnailURL={"./thumbnail1.webp"} duration={"4:17:17"} />
                        </Panel>
