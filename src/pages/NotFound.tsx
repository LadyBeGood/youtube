...
export default function NotFound() {
    ...
    return (
        <>
            <button onClick={() => setIsSettingsBottomSheetOpen(true)}>Click</button>
            <BottomSheet isBottomSheetOpen={isSettingsBottomSheetOpen} middle={100} onBottomSheetClose={() => setIsSettingsBottomSheetOpen(false)}>
                ...
                <button className="flex gap-6 h-13 w-full hover:bg-white/10 items-center px-4" onClick={() => { console.log("button"); setLoopVideo(!loopVideo); setIsSettingsBottomSheetOpen(false) }}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
