import { FilledNotificationsIcon, NotificationsIcon } from "../components/Icons/Icons"

export default function Notifications() {

    return (
        <main className="flex items-center justify-center flex-col h-full mb-12 overflow-y-scroll no-scrollbar">
